...
// Driver module for Mongodb Connect support
...
mongoose
    .connect('mongodb://localhost:27017/groceryDB', { useNewUrlParser: true })
    .then(() => {
...
app.put('/items/:itemId', (req, res) => {
    ...
    var id = req.params.itemId;
    item.findByIdAndUpdate(id, data, { new: true, upsert: true })
        .then((updatedItem) => {
...
app.delete('/items/:itemId', (req, res) => {
    var id = req.params.itemId;
    item.findByIdAndDelete(id, { new: true, upsert: true })
        .then(() => {
